...
\section{Spatial Model Forecasting}
	...
	\begin{figure}
        ...
        \caption{Average SSE (log scale) across each location and all trials as a function  of the number of weeks ahead in the forecast. \label{sseplot}}
    \end{figure}
    ...
    \begin{figure}
        ...
        \caption{Runtimes for producing spatial SIR forecasts. The box shows the middle 50th quantile, the bold line is the median, and the dots are outliers. \label{timeplot}}
    \end{figure}
