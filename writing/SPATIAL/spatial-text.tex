...
\section{Spatial Model Forecasting}
    ...
    \begin{figure}
        ...
        \caption{Runtimes for producing spatial SIR forecasts. The box shows the middle 50th quantile, the bold line is the median, and the dots are outliers. \label{spatialtimeplot}}
    \end{figure}
