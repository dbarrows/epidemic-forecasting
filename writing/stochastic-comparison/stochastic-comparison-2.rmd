...
We can fit the model to successively smaller (or larger) time series to see the effect of truncation on forecast SSE. This was done below, with 10 new trajectories drawn for each of the desired lengths.
