...
\section{SIRS Model Forecasting}
	...
	To do this we generated a series of artificial time series of length $260$ meant to represent 5 years of weekly incidence counts and used each method to forecast up to 2 years into the future. Our goal here was to determine how forecast error changed with forecast length; while it is expected that we will see a positive correlation, we wish to determine how the methods stack up against each other.
