...
\section{Fitting}
    ...
    we obtain Figure [\ref{pfdataplot}].

    \begin{figure}
        \centering
        \captionsetup{width=0.8\linewidth}
        \includegraphics[width=0.8\textwidth]{./images/dataplot.pdf}
        \caption{True SIR ODE solution infected counts, and with added observation noise. \label{pfdataplot}}
    \end{figure}
    ...
    The final kernel estimates for four of the key parameters are shown in Figure [\ref{if2kernelplot}].

    \begin{figure}
        \centering
        \captionsetup{width=0.8\linewidth}
        \includegraphics[width=0.8\textwidth]{./images/if2kernels.pdf}
        \caption{Kernel estimates for four essential system parameters. True values are indicated by solid vertical lines, sample means by dashed lines. \label{if2kernelplot}}
    \end{figure}
