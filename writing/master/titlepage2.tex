\begin{titlepage}
	...
	\hbox{ % Horizontal box
		...
		\parbox[c][0.8\textheight]{0.05\textwidth}{
			\rule{1pt}{0.8\textheight} % Vertical line
		}
		%\hspace*{0.05\textwidth} % Whitespace between the vertical line and title page text
		\parbox[s][0.8\textheight]{0.95\textwidth}{ % Paragraph box which restricts text to less than the width of the page
